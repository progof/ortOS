...
run: mult_big_num.o guess_x.o compound_interest.o ./src/interface.hpp build_dir
	g++ ./src/interface.cpp ./$(BUILD_DIR)/mult_big_num.o ./$(BUILD_DIR)/guess_x.o ./$(BUILD_DIR)/compound_interest.o -o ./$(BUILD_DIR)/$(TARGET) && ./$(BUILD_DIR)/$(TARGET)
