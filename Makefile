TARGET = ortOS
BUILD_DIR = build
BUILD_APP = ./$(BUILD_DIR)/BigNumberProgram.o ./$(BUILD_DIR)/HelloWorldProgram.o ./$(BUILD_DIR)/IProgramController.o
...
BigNumberProgram.o: ./src/programs/BigNumberProgram.cpp ./src/programs/IProgramController.hpp  ./src/core/core.hpp build_dir
	$(CXX) -c ./src/programs/BigNumberProgram.cpp -o ./$(BUILD_DIR)/BigNumberProgram.o

HelloWorldProgram.o: ./src/programs/HelloWorldProgram.cpp ./src/programs/IProgramController.hpp  ./src/core/core.hpp build_dir
...
run: BigNumberProgram.o HelloWorldProgram.o IProgramController.o ./src/main.cpp build_dir
